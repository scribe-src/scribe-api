...
%html
  ...
  %body
    ...
    #content
      ...
      - if @entity.classProperties.length > 0
        %h2 Class Properties

        %dl.properties
          - for property in @entity.classProperties
      ...
      - if @entity.documentation?.events
        %h2 Instance Events
        - for event in @entity.documentation.events
          .event
            %p.signature
              = event.name
      ...
      - if @entity.inheritedMethods().length > 0
        %h2
          %small Inherited Instance Methods
